...
def run_epoch(
    ...
    for batch in pbar:
        ...
        with torch.set_grad_enabled(is_training):
            ...
            if is_training and flags.loss_weighting_strategy == 'mgda' and mgda_loss_fn is not None:
                ...
                for i, task_name in enumerate(TASK_CONFIG["names"]):
                    ...
                    if mask.any():
                        if task_criteria is not None:
                            ...
                            # Default to BCEWithLogitsLoss if task_criteria is None
                            loss_fn = nn.BCEWithLogitsLoss()
                            loss_i = loss_fn(logits[mask], labels[mask])
